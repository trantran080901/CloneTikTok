export const UploadIcon = ({ width = '2.7rem', height = '2.7rem', classNames }) => {
    return (
        <svg
...
export const InboxIcon = ({ width = '3.3rem', height = '3.3rem', classNames }) => {
    return (
        <svg
            className={classNames}
            width={width}
...
export const SearchIcon = ({ width = '2.4rem', height = '2.4rem', classNames }) => {
    return (
        <svg
            className={classNames}
            width={width}
